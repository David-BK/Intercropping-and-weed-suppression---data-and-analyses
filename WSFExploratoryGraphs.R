...
createExploratoryGraphs <- function(Data, Variable, Dir, OutputDir, ReturnTreatmentAverages = TRUE, ReturnAllTreatments = TRUE, ReturnTriples = TRUE, PDF = TRUE, XLab = "X", YLab = "Y", XMin = NULL, XMax = NULL, YMin = NULL, YMax = NULL, NTreatments = 19){
  Output <- list()
  ...
  if(ReturnAllTreatments | ReturnTriples){
    ...
    ColourVector <- brewer.pal(n=8,"Set1")
